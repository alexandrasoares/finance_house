...
@Component({
  selector: 'app-detalhes-movimentos',
  templateUrl: './detalhes-movimentos.page.html',
  styleUrls: ['./detalhes-movimentos.page.scss'],
})
export class DetalhesMovimentosPage implements OnInit {
  ...
  private loadForm(movimento: Movimento): void {
    const conta = (movimento.conta !== null) ? movimento.conta.nome : '';
    const categoria = (movimento.categoria !== null) ? movimento.categoria.nome : '';
    const subcategoria = (movimento.subcategoria !== null) ? movimento.subcategoria.nome : '';
    const cartao = (movimento.fatura !== null) ? movimento.fatura.cartao.nome : '';
    const fatura = (movimento.fatura !== null) ? movimento.fatura.referencia : '';
    const projeto = (movimento.projeto !== null) ? movimento.projeto.nome : '';
